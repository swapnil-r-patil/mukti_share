      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
             ...
             <div className="space-y-6">
                <div className="space-y-2">
                   ...
                   <input 
                     ...
                     className="w-full h-1.5 bg-secondary rounded-lg appearance-none cursor-pointer accent-orange-600"
                   />
                </div>

                <div className="space-y-3">
                   <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest px-1">Fraud Detection sensitivity</label>
                ...
                <div className="flex items-center justify-between p-4 rounded-2xl bg-secondary border border-border shadow-inner">
                   <div className="flex items-center gap-3">
                      ...
                      <div className="text-sm font-bold text-foreground uppercase tracking-wider">AI Fraud Prediction (ML)</div>
                   </div>
                   <button 
        ...
        <div className="rounded-[2.5rem] bg-card border border-border p-8 shadow-2xl relative flex flex-col overflow-hidden">
           ...
           <div className="flex-1 space-y-4">
              <div className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-4">Base Daily Rates for Income Projections (₹)</div>
